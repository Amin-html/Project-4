...
from django.conf.global_settings import DATABASES, MEDIA_URL, MEDIA_ROOT, LOGIN_URL
...
SECRET_KEY = 'django-insecure-x_9$o7o0=#)^)snk-8@n=xo-oopk7dl)7$i1hp$c7ng^4hl+!0'
